...
$(function() {
    ...
    $.getJSON('/joinsdi/sdilod/portal?action=getDayStat', function(data) {
        var date = [];
        var uv = [];
        var dl = [];
    ...
    $.getJSON('/joinsdi/sdilod/portal?action=getAggrStat', function(data) {
        var labels = [];
        var datasets = [];
        var th = '<tr>';
        var td = '<tr>';
    ...
    $.getJSON('/joinsdi/sdilod/portal?action=getRefer', function(data) {
        var refers = [];
        var html = '<p>来源网址</p>';
